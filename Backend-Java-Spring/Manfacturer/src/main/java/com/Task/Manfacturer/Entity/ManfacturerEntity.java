...
public class ManfacturerEntity {
	...
	public ManfacturerEntity(Long productQty, Long productId, String productSku, String productName,
	...
	public String toString() {
		return "ManfacturerEntity [productQty=" + productQty + ", productId=" + productId
				+ ", productSku="
